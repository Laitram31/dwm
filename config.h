...
static const Key keys[] = {
    ...
    { 0,                     XF86XK_AudioPrev,         spawn,            SHCMD("echo playlist-prev | socat - /tmp/mpvsocket") },
    { 0,                     XF86XK_AudioNext,         spawn,            SHCMD("echo playlist-next | socat - /tmp/mpvsocket") },
    { 0,                     XF86XK_AudioPlay,         spawn,            SHCMD("echo cycle pause | socat - /tmp/mpvsocket") },
    { 0,                     XF86XK_AudioStop,         spawn,            SHCMD("echo stop | socat - /tmp/mpvsocket") },
