...
static const Key keys[] = {
    ...
    { 0,                     XF86XK_AudioPrev,         spawn,            SHCMD("echo playlist-prev | socat - /tmp/mpvsocket; sleep 0.1 && kill -43 $(pidof dwmblocks)") },
    { 0,                     XF86XK_AudioNext,         spawn,            SHCMD("echo playlist-next | socat - /tmp/mpvsocket; sleep 0.1 && kill -43 $(pidof dwmblocks)") },
